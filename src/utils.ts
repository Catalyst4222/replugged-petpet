...
export const nitroLevels = Object.values(nitroLevelMod)
                                 ...
                                 .filter(value => Object.values(value as object)
                                                         .every(item => item?.limits))[0] as Record<number, NitroLevel>

const getUserMaxFileSize = webpack.getByProps("getUserMaxFileSize")!.getUserMaxFileSize as (user: User) => number
